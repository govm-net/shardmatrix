...
import (
	...
	"github.com/govm-net/shardmatrix/app"
)
...
// genesisCommand builds genesis-related `shardmatrixd genesis` command. Users may provide application specific commands as a parameter
